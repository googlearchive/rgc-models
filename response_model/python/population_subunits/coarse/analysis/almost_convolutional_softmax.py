...
class AlmostConvolutionalSoftmax(almost_convolutional.AlmostConvolutionalModel):
  ...
  def __init__(self, loss_string, stim, resp, short_filename, window=2,
    ...
    short_filename = ('model=' + 'almost_convolutional_softmax' + '_window=' +
    ...
    model_prb = model_probes(su_act_softmax, su_act, lam_normalized, loss,
                             loss_unregularized, stim, resp, lam)

...
class AlmostConvolutionalExpDropoutOnlyWdelta(almost_convolutional.AlmostConvolutionalModel):
  ...
  def __init__(self, loss_string, stim, resp, short_filename, window=2,
    ...
    '''
    fraction_cells = 0.02 # TODO(bhaishahster): would be set by user in future
